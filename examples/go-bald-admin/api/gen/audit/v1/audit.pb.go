...
const file_audit_v1_audit_proto_rawDesc = "" +
	...
	"\x0eGetAuditRecord\x12-.go.bald.admin.audit.v1.GetAuditRecordRequest\x1a..go.bald.admin.audit.v1.GetAuditRecordResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/audit/{id}B\xf1\x01\n" +
	"\x1acom.go.bald.admin.audit.v1B\n" +
	"AuditProtoP\x01ZJgithub.com/kalandramo/bald/examples/go-bald-admin/api/gen/audit/v1;auditv1\xa2\x02\x04GBAA\xaa\x02\x16Go.Bald.Admin.Audit.V1\xca\x02\x16Go\\Bald\\Admin\\Audit\\V1\xe2\x02\"Go\\Bald\\Admin\\Audit\\V1\\GPBMetadata\xea\x02\x1aGo::Bald::Admin::Audit::V1b\x06proto3"
