...
// Compile-time assertion: sentryLog implements log.Logger.
var _ log.Logger = (*sentryLog)(nil)
...
func (s *sentryLog) With(keyvals ...any) log.Logger {
	return &sentryLog{
		hub:   s.hub,
...
func (s *sentryLog) Enabled(_ log.Level) bool {
	return true
}
...
func levelToInt(level log.Level) string {
