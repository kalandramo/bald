...
//	    cobramcp.AnnotationArgPrefix + "0": "The on-call module name (e.g. 'bke', 'kafka')",
//	    cobramcp.AnnotationArgPrefix + "1": "Brief title describing the incident",
//	}
const AnnotationArgPrefix = "cobramcp.arg."
...
//  1. cmd.Annotations["cobramcp.arg.<index>"]  (highest priority, explicit)
