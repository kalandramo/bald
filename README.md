...
├── circuitbreaker/           # 熔断契约（三态 State + Allow/MarkSuccess/MarkFailure 成对上报 + Execute 便捷包装；四实现各自独立 module：sres SRE 概率式 / vegas RTT 膨胀 / hystrix 阈值+睡窗 / sentinel 桥接）
├── pkg/
