...
- [slog 日志能力接入路线](./slog%20日志能力接入路线.md)：评估 gookit/slog 能力在 pkg/log/slog.go 落地的可行性；文件轮转用已有 lumberjack、彩色控制台用 tint，Processor/Filter/多 Handler 已由 ContextWithAttrs/FilterKey/multiWriter 覆盖。
