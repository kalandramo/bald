...
const (
	...
	// 全文检索与精确匹配
	Operator_SEARCH Operator = 26 // 全文搜索（服务端按需实现）
...
const (
	...
	DatePart_ISO_YEAR              DatePart = 3  // ISO 8601 年
	DatePart_QUARTER               DatePart = 4  // 季度
	DatePart_MONTH                 DatePart = 5  // 月
	DatePart_WEEK                  DatePart = 6  // ISO 8601 周编号
...
func (Sorting_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_bald_store_v1_store_proto_enumTypes[3].Descriptor()
}

func (Sorting_Direction) Type() protoreflect.EnumType {
	return &file_bald_store_v1_store_proto_enumTypes[3]
}
...
func (Sorting_Direction) EnumDescriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{0, 0}
}
...
type Sorting struct {
	...
	// 排序方向
	Direction     Sorting_Direction `protobuf:"varint,2,opt,name=direction,proto3,enum=bald.store.v1.Sorting_Direction" json:"direction,omitempty"`
...
type FilterCondition struct {
	...
	Field string `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"`
	// 过滤操作符
	Op Operator `protobuf:"varint,2,opt,name=op,proto3,enum=bald.store.v1.Operator" json:"op,omitempty"`
	...
	DatePart *DatePart `protobuf:"varint,5,opt,name=date_part,json=datePart,proto3,enum=bald.store.v1.DatePart,oneof" json:"date_part,omitempty"`
...
type FilterExpr struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// 过滤表达式类型
	Type ExprType `protobuf:"varint,1,opt,name=type,proto3,enum=bald.store.v1.ExprType" json:"type,omitempty"`
	// 条件列表
...
func (x *TokenBasedPagination) Reset() {
	*x = TokenBasedPagination{}
	mi := &file_bald_store_v1_store_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TokenBasedPagination) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{5}
}
...
func (x *NoPaging) Reset() {
	*x = NoPaging{}
	mi := &file_bald_store_v1_store_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NoPaging) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{6}
}
...
func (x *PagingRequest) Reset() {
	*x = PagingRequest{}
	mi := &file_bald_store_v1_store_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PagingRequest) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{7}
}
...
func (x *PaginationResponseMeta) Reset() {
	*x = PaginationResponseMeta{}
	mi := &file_bald_store_v1_store_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PaginationResponseMeta) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{8}
}
...
func (x *PagingResponse) Reset() {
	*x = PagingResponse{}
	mi := &file_bald_store_v1_store_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PagingResponse) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{9}
}
...
func (x *PaginationRequest) Reset() {
	*x = PaginationRequest{}
	mi := &file_bald_store_v1_store_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PaginationRequest) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{10}
}
...
func (x *PaginationResponse) Reset() {
	*x = PaginationResponse{}
	mi := &file_bald_store_v1_store_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PaginationResponse) Descriptor() ([]byte, []int) {
	return file_bald_store_v1_store_proto_rawDescGZIP(), []int{11}
}
...
const file_bald_store_v1_store_proto_rawDesc = "" +
	"\n" +
	"\x19bald/store/v1/store.proto\x12\rbald.store.v1\x1a google/protobuf/field_mask.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x7f\n" +
	"\aSorting\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12>\n" +
	"\tdirection\x18\x02 \x01(\x0e2 .bald.store.v1.Sorting.DirectionR\tdirection\"\x1e\n" +
	"\tDirection\x12\a\n" +
	"\x03ASC\x10\x00\x12\b\n" +
	"\x04DESC\x10\x01\"\xc1\x02\n" +
	"\x0fFilterCondition\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12'\n" +
	"\x02op\x18\x02 \x01(\x0e2\x17.bald.store.v1.OperatorR\x02op\x12\x16\n" +
	"\x05value\x18\x03 \x01(\tH\x00R\x05value\x127\n" +
	"\n" +
	"json_value\x18\a \x01(\v2\x16.google.protobuf.ValueH\x00R\tjsonValue\x12\x16\n" +
	"\x06values\x18\x04 \x03(\tR\x06values\x129\n" +
	"\tdate_part\x18\x05 \x01(\x0e2\x17.bald.store.v1.DatePartH\x01R\bdatePart\x88\x01\x01\x12 \n" +
	...
	"\n" +
	"FilterExpr\x12+\n" +
	"\x04type\x18\x01 \x01(\x0e2\x17.bald.store.v1.ExprTypeR\x04type\x12>\n" +
	"\n" +
	"conditions\x18\x02 \x03(\v2\x1e.bald.store.v1.FilterConditionR\n" +
	"conditions\x121\n" +
	"\x06groups\x18\x03 \x03(\v2\x19.bald.store.v1.FilterExprR\x06groups\"F\n" +
	"\x13PageBasedPagination\x12\x12\n" +
	"\x04page\x18\x01 \x01(\rR\x04page\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\rR\bpageSize\"E\n" +
	"\x15OffsetBasedPagination\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\rR\x05limit\"I\n" +
	"\x14TokenBasedPagination\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\rR\bpageSize\"\n" +
	"\n" +
	"\bNoPaging\"\xb3\x04\n" +
	"\rPagingRequest\x12\x17\n" +
	"\x04page\x18\x01 \x01(\rH\x01R\x04page\x88\x01\x01\x12 \n" +
	"\tpage_size\x18\x02 \x01(\rH\x02R\bpageSize\x88\x01\x01\x12\x1b\n" +
	"\x06offset\x18\x03 \x01(\x04H\x03R\x06offset\x88\x01\x01\x12\x19\n" +
	"\x05limit\x18\x04 \x01(\rH\x04R\x05limit\x88\x01\x01\x12\x19\n" +
	"\x05token\x18\x05 \x01(\tH\x05R\x05token\x88\x01\x01\x12 \n" +
	"\tno_paging\x18\x06 \x01(\bH\x06R\bnoPaging\x88\x01\x01\x12\x16\n" +
	"\x05query\x18\n" +
	" \x01(\tH\x00R\x05query\x12\x18\n" +
	"\x06filter\x18\v \x01(\tH\x00R\x06filter\x12<\n" +
	"\vfilter_expr\x18\f \x01(\v2\x19.bald.store.v1.FilterExprH\x00R\n" +
	"filterExpr\x12\x1e\n" +
	"\border_by\x18\x14 \x01(\tH\aR\aorderBy\x88\x01\x01\x120\n" +
	"\asorting\x18\x15 \x03(\v2\x16.bald.store.v1.SortingR\asorting\x12>\n" +
	"\n" +
	"field_mask\x18\x1e \x01(\v2\x1a.google.protobuf.FieldMaskH\bR\tfieldMask\x88\x01\x01B\x10\n" +
	...
	"_page_sizeB\x0f\n" +
	"\r_current_size\"i\n" +
	"\x0ePagingResponse\x127\n" +
	"\x05total\x18\x01 \x01(\v2\x1c.google.protobuf.UInt64ValueH\x00R\x05total\x88\x01\x01\x12\x14\n" +
	"\x05items\x18\x02 \x03(\fR\x05itemsB\b\n" +
	"\x06_total\"\xe6\x04\n" +
	"\x11PaginationRequest\x12C\n" +
	"\n" +
	"page_based\x18\x01 \x01(\v2\".bald.store.v1.PageBasedPaginationH\x00R\tpageBased\x12I\n" +
	"\foffset_based\x18\x02 \x01(\v2$.bald.store.v1.OffsetBasedPaginationH\x00R\voffsetBased\x12F\n" +
	"\vtoken_based\x18\x03 \x01(\v2#.bald.store.v1.TokenBasedPaginationH\x00R\n" +
	"tokenBased\x126\n" +
	"\tno_paging\x18\x04 \x01(\v2\x17.bald.store.v1.NoPagingH\x00R\bnoPaging\x12\x16\n" +
	"\x05query\x18\n" +
	" \x01(\tH\x01R\x05query\x12\x18\n" +
	"\x06filter\x18\v \x01(\tH\x01R\x06filter\x12<\n" +
	"\vfilter_expr\x18\f \x01(\v2\x19.bald.store.v1.FilterExprH\x01R\n" +
	"filterExpr\x12\x1e\n" +
	"\border_by\x18\x14 \x01(\tH\x02R\aorderBy\x88\x01\x01\x120\n" +
	"\asorting\x18\x15 \x03(\v2\x16.bald.store.v1.SortingR\asorting\x12>\n" +
	"\n" +
	"field_mask\x18\x1e \x01(\v2\x1a.google.protobuf.FieldMaskH\x03R\tfieldMask\x88\x01\x01B\x11\n" +
	"\x0fpagination_typeB\x10\n" +
	"\x0efiltering_typeB\v\n" +
	"\t_order_byB\r\n" +
	"\v_field_mask\"y\n" +
	"\x12PaginationResponse\x129\n" +
	"\x04meta\x18\x02 \x01(\v2%.bald.store.v1.PaginationResponseMetaR\x04meta\x12(\n" +
...
var file_bald_store_v1_store_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_bald_store_v1_store_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_bald_store_v1_store_proto_goTypes = []any{
	(Operator)(0),                  // 0: bald.store.v1.Operator
	(DatePart)(0),                  // 1: bald.store.v1.DatePart
	(ExprType)(0),                  // 2: bald.store.v1.ExprType
	(Sorting_Direction)(0),         // 3: bald.store.v1.Sorting.Direction
	(*Sorting)(nil),                // 4: bald.store.v1.Sorting
	(*FilterCondition)(nil),        // 5: bald.store.v1.FilterCondition
	(*FilterExpr)(nil),             // 6: bald.store.v1.FilterExpr
	(*PageBasedPagination)(nil),    // 7: bald.store.v1.PageBasedPagination
	(*OffsetBasedPagination)(nil),  // 8: bald.store.v1.OffsetBasedPagination
	(*TokenBasedPagination)(nil),   // 9: bald.store.v1.TokenBasedPagination
	(*NoPaging)(nil),               // 10: bald.store.v1.NoPaging
	(*PagingRequest)(nil),          // 11: bald.store.v1.PagingRequest
	(*PaginationResponseMeta)(nil), // 12: bald.store.v1.PaginationResponseMeta
	(*PagingResponse)(nil),         // 13: bald.store.v1.PagingResponse
	(*PaginationRequest)(nil),      // 14: bald.store.v1.PaginationRequest
	(*PaginationResponse)(nil),     // 15: bald.store.v1.PaginationResponse
...
var file_bald_store_v1_store_proto_depIdxs = []int32{
	3,  // 0: bald.store.v1.Sorting.direction:type_name -> bald.store.v1.Sorting.Direction
	0,  // 1: bald.store.v1.FilterCondition.op:type_name -> bald.store.v1.Operator
	16, // 2: bald.store.v1.FilterCondition.json_value:type_name -> google.protobuf.Value
	1,  // 3: bald.store.v1.FilterCondition.date_part:type_name -> bald.store.v1.DatePart
	2,  // 4: bald.store.v1.FilterExpr.type:type_name -> bald.store.v1.ExprType
	5,  // 5: bald.store.v1.FilterExpr.conditions:type_name -> bald.store.v1.FilterCondition
	6,  // 6: bald.store.v1.FilterExpr.groups:type_name -> bald.store.v1.FilterExpr
	6,  // 7: bald.store.v1.PagingRequest.filter_expr:type_name -> bald.store.v1.FilterExpr
	4,  // 8: bald.store.v1.PagingRequest.sorting:type_name -> bald.store.v1.Sorting
	17, // 9: bald.store.v1.PagingRequest.field_mask:type_name -> google.protobuf.FieldMask
	18, // 10: bald.store.v1.PaginationResponseMeta.total:type_name -> google.protobuf.UInt64Value
	19, // 11: bald.store.v1.PaginationResponseMeta.total_pages:type_name -> google.protobuf.UInt32Value
	19, // 12: bald.store.v1.PaginationResponseMeta.current_page:type_name -> google.protobuf.UInt32Value
	18, // 13: bald.store.v1.PaginationResponseMeta.current_offset:type_name -> google.protobuf.UInt64Value
	18, // 14: bald.store.v1.PagingResponse.total:type_name -> google.protobuf.UInt64Value
	7,  // 15: bald.store.v1.PaginationRequest.page_based:type_name -> bald.store.v1.PageBasedPagination
	8,  // 16: bald.store.v1.PaginationRequest.offset_based:type_name -> bald.store.v1.OffsetBasedPagination
	9,  // 17: bald.store.v1.PaginationRequest.token_based:type_name -> bald.store.v1.TokenBasedPagination
	10, // 18: bald.store.v1.PaginationRequest.no_paging:type_name -> bald.store.v1.NoPaging
	6,  // 19: bald.store.v1.PaginationRequest.filter_expr:type_name -> bald.store.v1.FilterExpr
	4,  // 20: bald.store.v1.PaginationRequest.sorting:type_name -> bald.store.v1.Sorting
	17, // 21: bald.store.v1.PaginationRequest.field_mask:type_name -> google.protobuf.FieldMask
	12, // 22: bald.store.v1.PaginationResponse.meta:type_name -> bald.store.v1.PaginationResponseMeta
	20, // 23: bald.store.v1.PaginationResponse.data:type_name -> google.protobuf.Any
...
func file_bald_store_v1_store_proto_init() {
	...
	file_bald_store_v1_store_proto_msgTypes[1].OneofWrappers = []any{
		(*FilterCondition_Value)(nil),
		(*FilterCondition_JsonValue)(nil),
	}
	file_bald_store_v1_store_proto_msgTypes[7].OneofWrappers = []any{
		(*PagingRequest_Query)(nil),
		(*PagingRequest_Filter)(nil),
		(*PagingRequest_FilterExpr)(nil),
	}
	file_bald_store_v1_store_proto_msgTypes[8].OneofWrappers = []any{}
	file_bald_store_v1_store_proto_msgTypes[9].OneofWrappers = []any{}
	file_bald_store_v1_store_proto_msgTypes[10].OneofWrappers = []any{
