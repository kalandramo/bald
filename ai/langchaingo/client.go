...
func NewModel(cfg *Config, opts ...Option) (llms.Model, error) {
	if cfg == nil {
...
func newCloudModel(cfg *Config, o *options) (llms.Model, error) {
	if cfg.Cloud == nil {
	...
	opts := []lcOpenai.Option{
		...
		lcOpenai.WithModel(cfg.ModelName),
	}
	...
	if cfg.Cloud.Organization != "" {
		opts = append(opts, lcOpenai.WithOrganization(cfg.Cloud.Organization))
	}
...
func newOllamaModel(cfg *Config, o *options) (llms.Model, error) {
	if cfg.Local == nil {
	...
	opts := []lcOllama.Option{
		lcOllama.WithModel(cfg.ModelName),
